...
import StarImage from './assets/images/star_1.png'
...
const Image = styled('div', {
  ...
  backgroundImage: props.hotel.image || `url(${ImageImage})`,
        ...
        <Content1>
          <About>
            <Label>
              <Frame1>
                <Text>
                  <Label1>{props.hotel.tag}</Label1>
                </Text>
              </Frame1>
            </Label>
            <SizeDetails>{props.hotel.details}</SizeDetails>
          </About>
          <Details>
          ...
          <LowerRow>
            <LockUp>
              <Price>{props.hotel.price}</Price>
              <Rating>
                <Star src={StarImage} alt={'star'} />
                <Rating1>{props.hotel.rating}</Rating1>
              </Rating>
            </LockUp>
            <Button1>
              <Tooltip
                arrow={true}
                placement={'top'}
                title={'You can apply a 10% discount'}
              >
                <ButtonContained
                  variant="contained"
                  size="large"
